...
- Export generation of IR WAV files (Linear, Minimum, Mixed phase) with selectable sample rates.
...
4. **Generate IRs**: Produce WAV IR files for selected sample rates and phase types.
...
- Генерация WAV ИХ (линейная, минимальная, смешанная фаза) с выбором частоты дискретизации.
...
4. **Генерация ИХ**: Создание WAV-файлов ИХ для выбранных частот дискретизации и типов фазы.